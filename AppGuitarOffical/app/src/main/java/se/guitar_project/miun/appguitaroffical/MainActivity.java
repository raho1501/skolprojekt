package se.guitar_project.miun.appguitaroffical;

import android.support.v7.app.AppCompatActivity;
import android.os.Bundle;
import android.widget.TextView;
import se.guitar_project.miun.appguitaroffical.R;


//Exempel aktivitet för att hämta Xml genom HTTP med våran XmlRestInterface.
