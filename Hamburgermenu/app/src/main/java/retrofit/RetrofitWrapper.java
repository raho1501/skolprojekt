...
public class RetrofitWrapper
{
    ...
    public Budgets getBudgets(final RetroCallback<Budgets> func)
    {
        Budgets budgets = new Budgets();
        Call<Budgets> call;
        call = client.getAllBudgets();

        call.enqueue(new Callback<Budgets>(){

            @Override
            public void onResponse(Call<Budgets> call, Response<Budgets> response) {
                func.onResponse(response.body());
            }

            @Override
            public void onFailure(Call<Budgets> call, Throwable t) {
                t.printStackTrace();
            }
        });
